...
// Order matters — this is the shop-floor flow, left to right.
const TILES = [
  { key: 'total',       label: 'Total Jobs',  color: 'var(--text)' },
  { key: 'inProgress',  label: 'In Progress', color: 'var(--green)' },
  ...
  { key: 'enquiry',     label: 'Enquiry',     color: 'var(--text2)' },
  { key: 'design',      label: 'Design',      color: 'var(--purple, #7c3aed)' },
  { key: 'jobsetter',   label: 'Job Setter',  color: 'var(--amber)' },
  { key: 'production',  label: 'Production',  color: 'var(--red)' },
  { key: 'qc',          label: 'QC',          color: 'var(--blue)' },
  { key: 'dispatch',    label: 'Dispatch',    color: 'var(--green)' },
  { key: 'approval',    label: '⏳ Approval',  color: 'var(--amber)' },
  { key: 'onlineStaff', label: '🟢 Online Staff', color: 'var(--green)' },
];
