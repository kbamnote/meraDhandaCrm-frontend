...
const SECTION_S = {
  ...
  '🧾 Invoice View':      { en: '🧾 Invoice View',      hi: '🧾 इनवॉइस व्यू',          hinglish: '🧾 Invoice View',       gu: '🧾 ઇન્વોઇસ વ્યૂ',         mr: '🧾 इनव्हॉइस व्ह्यू',      mwr: '🧾 इनवॉइस व्यू' },
  ...
  '📓 Day Book':          { en: '📓 Day Book',          hi: '📓 दिन-बही',              hinglish: '📓 Day Book',           gu: '📓 ડે બુક',              mr: '📓 डे बुक',              mwr: '📓 दिन-बही' },
  '📈 Profitability':     { en: '📈 Profitability',     hi: '📈 लाभप्रदता',            hinglish: '📈 Profitability',      gu: '📈 નફાકારકતા',           mr: '📈 नफा',                 mwr: '📈 लाभ' },
  '🗓️ Year-End Close':    { en: '🗓️ Year-End Close',    hi: '🗓️ वर्ष-अंत क्लोजिंग',    hinglish: '🗓️ Year-End Close',     gu: '🗓️ વર્ષ-અંત ક્લોઝિંગ',    mr: '🗓️ वर्ष-अखेर क्लोजिंग',   mwr: '🗓️ बरस-अंत क्लोजिंग' },
  '🏭 Job Profitability': { en: '🏭 Job Profitability', hi: '🏭 जॉब लाभप्रदता',         hinglish: '🏭 Job Profitability',  gu: '🏭 જોબ નફાકારકતા',        mr: '🏭 जॉब नफा',              mwr: '🏭 जॉब लाभ' },
  '💰 Accounting':         { en: '💰 Accounting',         hi: '💰 अकाउंटिंग',           hinglish: '💰 Accounting',         gu: '💰 એકાઉન્ટિંગ',          mr: '💰 अकाउंटिंग',           mwr: '💰 अकाउंटिंग' },
...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/invoice-view',     label: '🧾 Invoice View',     legacy: 'page-invoice-view' },
      ...
      { to: '/accounting/purchases', label: '📦 Purchases',     legacy: 'page-accounting-purchases' },
      { to: '/accounting/reports', label: '📊 Reports',        legacy: 'page-accounting-reports' },
      { to: '/accounting/gst',   label: '🧮 GST',              legacy: 'page-accounting-gst' },
      { to: '/accounting/credit-notes', label: '📝 Credit Notes', legacy: 'page-accounting-credit-notes' },
      { to: '/accounting/debit-notes',  label: '📝 Debit Notes',  legacy: 'page-accounting-debit-notes' },
      { to: '/accounting/challans',     label: '🚚 Challans',     legacy: 'page-accounting-challans' },
      { to: '/accounting/recurring',    label: '🔁 Recurring',     legacy: 'page-accounting-recurring' },
      { to: '/accounting/branches',     label: '🏬 Branches',      legacy: 'page-accounting-branches' },
      { to: '/accounting/search',       label: '🔍 Search',        legacy: 'page-accounting-search' },
      ...
      { to: '/accounting/daybook',   label: '📓 Day Book',     legacy: 'page-accounting-daybook' },
      { to: '/accounting/profit',    label: '📈 Profitability', legacy: 'page-accounting-profit' },
      { to: '/accounting/year-end',  label: '🗓️ Year-End Close', legacy: 'page-accounting-year-end' },
      { to: '/accounting/job-profit',label: '🏭 Job Profitability', legacy: 'page-accounting-job-profit' },
