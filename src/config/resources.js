...
export const RESOURCES = {
  vendors: {
    ...
    fields: [
      ...
      { key: 'bankAccount', label: 'Account no.', type: 'text' },
      { key: 'ifsc', label: 'IFSC', type: 'text' },
      { key: 'qr', label: 'Payment QR (image URL)', type: 'text' },
  ...
  expenses: {
    collection: 'expenses', title: '🧾 Expenses', plural: 'Expenses', singular: 'Expense',
    legacyId: 'page-expenses', writeRoles: ADMIN,
    fields: [
      { key: 'category', label: 'Category', type: 'text', required: true, table: true },
      { key: 'amount', label: 'Amount (₹)', type: 'number', required: true, table: true },
      { key: 'date', label: 'Date', type: 'date', table: true },
      { key: 'paymentMode', label: 'Payment mode', type: 'select', options: ['cash', 'bank', 'upi', 'card'], table: true },
  ...
  'purchase-orders': {
    collection: 'purchaseOrders', title: '📦 Purchase Orders', plural: 'Purchase Orders', singular: 'PO',
    legacyId: 'page-purchase-orders', writeRoles: ADMIN,
    fields: [
      { key: 'poNo', label: 'PO No.', type: 'text', table: true },
      { key: 'vendorName', label: 'Vendor', type: 'text', required: true, table: true },
      { key: 'date', label: 'Date', type: 'date', table: true },
      { key: 'total', label: 'Total (₹)', type: 'number', table: true },
      { key: 'status', label: 'Status', type: 'select', options: ['draft', 'sent', 'received'], table: true },
  ...
  machines: {
    ...
    fields: [
      ...
      { key: 'nextService', label: 'Next service due', type: 'date', table: true },
      { key: 'partsPhoto', label: 'Parts photo (image URL)', type: 'text' },
